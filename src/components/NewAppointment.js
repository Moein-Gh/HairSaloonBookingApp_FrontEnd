  ...
  const steps = [
    {
      ...
      content: (
        <Row className="formContainer">
          ...
          <Collapse
            bordered={false}
            expandIcon={({ isActive }) => <CaretLeftOutlined rotate={isActive ? 270 : 0} />}
            className="site-collapse-custom-collapse facilityCollapseContainer"
          >
            <Panel header="&nbsp; انتخاب آرایشگاه " key="1" className="facilityCollapse">
              <ChooseFacility />
            </Panel>
          </Collapse>
          ...
          >
            <Panel header="&nbsp; انتخاب آرایشگر" key="2" className="barberCollapse">
              <ChooseBarber />
            </Panel>
          </Collapse>
        </Row>
